...
const oeuvres = [
    {
        ...
        images: [
            ...
            'https://res.cloudinary.com/dazhkrimv/image/upload/v1777443641/3_4b8843d8-0ab7-4fd0-bcb6-6983a224d83f_kkgh41.png',
    ...
    },
    {
        ...
        images: [
            ...
            'https://res.cloudinary.com/dazhkrimv/image/upload/v1777443864/11_d8685905-f141-4225-9957-19b78e6fd892_n8qhyt.png',
        ...
        <main style={{ background: '#fff' }}>
            <section style={{ position: 'relative', width: '100%', height: '50vh', overflow: 'hidden' }}>
                ...
                <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <h1 style={{ ...font, color: '#fff', fontSize: 'clamp(32px, 5vw, 64px)', fontWeight: 500, letterSpacing: '0.08em', textTransform: 'uppercase' }}>DYANE. Découvrez les créations.</h1>
                </div>
            </section>
