    ...
    return (
        <div style={{ position: 'fixed', inset: 0, zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div style={{ position: 'absolute', inset: 0 }}>
                <Image src="/hero.png" alt="" fill style={{ objectFit: 'cover' }} />
            ...
            <div style={{ position: 'relative', textAlign: 'center', padding: '40px 24px', maxWidth: '600px', width: '100%' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', maxWidth: '400px', margin: '0 auto 40px' }}>
                    <button
                        onClick={confirm}
                        style={{ ...font, background: 'transparent', color: '#fff', border: '1px solid rgba(255,255,255,0.6)', padding: '16px 24px', fontSize: '12px', letterSpacing: '0.26em', textTransform: 'uppercase', cursor: 'pointer' }}
                    >
                        I'M OF LEGAL AGE
                    </button>
                    <button
                        onClick={deny}
                        style={{ ...font, background: 'transparent', color: '#fff', border: '1px solid rgba(255,255,255,0.3)', padding: '16px 24px', fontSize: '12px', letterSpacing: '0.26em', textTransform: 'uppercase', cursor: 'pointer', opacity: 0.7 }}
                    >
