        ...
        <>
            ...
            <section style={{ position: 'relative', width: '100%', height: '100vh', overflow: 'hidden', background: '#0d0d0d' }}>
                ...
                <div className="hero-text" style={{ position: 'absolute', bottom: '60px', left: '48px', textAlign: 'left', color: '#fff', maxWidth: '600px' }}>
                    ...
                    <h1 className="hero-titre" style={{ fontFamily: 'Playfair Display, serif', fontSize: 'clamp(16px, 2vw, 28px)', fontWeight: 400, letterSpacing: '0.04em', textTransform: 'uppercase', lineHeight: 1.2, margin: '0 0 16px' }}>{t('titre')}</h1>
                    <p className="hero-sous-titre" style={{ fontFamily: 'Lora, serif', fontSize: '12px', letterSpacing: '0.06em', lineHeight: 1.7, opacity: 0.75, margin: 0 }}>{t('sous_titre')}</p>
                </div>
            </section>
        </>
    )
