        ...
        <>
            <style>{`
                @media (max-width: 768px) {
                    .manifeste-grid { grid-template-columns: 1fr !important; gap: 48px !important; }
                    .manifeste-wrap { padding: 48px 24px !important; }
                    .manifeste-logo { width: 100% !important; max-width: 280px !important; }
                }
            `}</style>
            <section className="manifeste-wrap" style={{ background: '#fff', padding: '80px 64px' }}>
                <div className="manifeste-grid" style={{ maxWidth: '900px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'start' }}>
                    ...
                    <div>
                        ...
                        <p style={{ ...lora, fontSize: '14px', fontStyle: 'italic', lineHeight: 1.9, opacity: 0.8, marginBottom: '24px' }}>Flacons en porcelaine peints à la main.</p>
